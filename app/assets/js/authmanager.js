...
exports.addMojangAccount = async function (username) {
    if (username) {
        const ret = ConfigManager.addMojangAuthAccount(uuidv3(username + machineIdSync(), uuidv3.DNS), 'CrackeadoPorSunloolksksks', username, username)
        if (ConfigManager.getClientToken() == null) {
            ConfigManager.setClientToken('CrackeadoPorSunloolksksks')
        }
        ConfigManager.save()
        return ret
    }
